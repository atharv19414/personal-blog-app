...
const blogPost = new mongoose.Schema({
    title: {
        type: String,
        required: [true, "check data entry: title"]
    },
    post: {
        type: String,
        required: [true, "check data entry: post"]
    }
});
...
app.get("/posts/:day", function(req, res) {
    let parameter = req.params.day;
    Post.findOne({ _id: parameter }, (err, docs) => {
        console.log(parameter);
        res.render("post", { title: docs.title, body: docs.post });
    });
